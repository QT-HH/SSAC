...
browser.get(url='https://sports.news.naver.com/esports/news/index.nhn?isphoto=N')
time.sleep(1)
...
for i in links:
    ...
    link = str(data.select('body > #wrap > #container > #content > .news_wrap > .content > .content_area > .news_headline > .info > .press_link')).split('href="')[1].split('"')[0]
    # print(link)
    lnk.append(link)
...
with open('newsEsports.json', 'w', encoding="utf-8") as make_file:
